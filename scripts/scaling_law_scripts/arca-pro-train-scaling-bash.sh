...
CONFIGS=(
    ...
    "$CONFIG_DIR/arca-pro-energy-config-20k.yaml"
    "$CONFIG_DIR/arca-pro-energy-config-50k.yaml"
    "$CONFIG_DIR/arca-pro-energy-config-100k.yaml"
    "$CONFIG_DIR/arca-pro-energy-config-200k.yaml"
    "$CONFIG_DIR/arca-pro-energy-config-500k.yaml"
    "$CONFIG_DIR/arca-pro-energy-config-1M.yaml"
    "$CONFIG_DIR/arca-pro-energy-config-2M.yaml"
    "$CONFIG_DIR/arca-pro-energy-config-5M.yaml"
    "$CONFIG_DIR/arca-pro-energy-config-10M.yaml"
    "$CONFIG_DIR/arca-pro-energy-config-20M.yaml"
)
...
for CONFIG in "${CONFIGS[@]}"; do
    ...
    echo "=========================================="
    srun python scripts/arca-pro-train.py \
        --config "$CONFIG"
