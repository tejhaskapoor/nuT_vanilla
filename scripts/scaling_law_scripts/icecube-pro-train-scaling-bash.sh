...
#SBATCH --output=/lustre/fsn1/projects/rech/lba/commun/logs_and_ckpts/slurm_logs/icecube_nuT_scaling_output.out
#SBATCH --error=/lustre/fsn1/projects/rech/lba/commun/logs_and_ckpts/slurm_logs/icecube_nuT_scaling_error.err
...
CONFIG_DIR="/lustre/fsn1/projects/rech/lba/commun/nuT_vanilla/configs/scaling_law_config_files/configs_icecube_scaling_studies"
