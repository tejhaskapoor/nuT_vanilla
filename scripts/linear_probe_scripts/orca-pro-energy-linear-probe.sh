...
CKPT="/lustre/fsn1/projects/rech/lba/commun/logs_and_ckpts/ckpt/Prometheus FlowerS - nuT_no_graphnet/Energy Reconstruction 1M/Energy Reconstruction 1M_epoch=38_val_loss=0.0435.ckpt"
